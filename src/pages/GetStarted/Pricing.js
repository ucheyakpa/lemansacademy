    ...
    <PricingContainer>
      ...
      <PricingWrapper>
        ...
        <PriceWrap>
          ...
          <ActionButton
            href="https://paystack.com/pay/bcqtofvyv6"
            target="_blank"
          >
            Pay
          </ActionButton>
        ...
        <PriceWrap>
          ...
          <ActionButton
            href="https://paystack.com/pay/papbnqfpr4"
            target="_blank"
          >
            Pay
          </ActionButton>
        ...
        <PriceWrap>
          ...
          <ActionButton
            href="https://paystack.com/pay/opgsoc2592"
            target="_blank"
          >
            Pay
          </ActionButton>
      ...
      <OtherContainer>
        <Link to="/tutor" onClick={toggleHome}>
          <HomeLesson>Get a home lesson tutor</HomeLesson>
        </Link>
        <Link to="/payment" onClick={toggleHome}>
          <HomeLesson>Other Payment Options</HomeLesson>
        </Link>
      </OtherContainer>
    </PricingContainer>
  );
